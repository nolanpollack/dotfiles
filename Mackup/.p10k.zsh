# Generated by Powerlevel10k configuration wizard on 2024-04-22 at 15:53 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_FOREGROUND83
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_BACKGROUND=1

  ###################[ command_execution_time: du88888n of the last command ]###################
